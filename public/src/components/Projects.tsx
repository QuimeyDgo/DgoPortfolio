  ...
  return (
    <section id="projects" className="py-20 px-6 bg-[#131722]">
      <div className="max-w-6xl mx-auto">
        ...
        {expandedIndex !== null && (
          <div
            className="fixed inset-0 z-50 bg-gray-950/70 backdrop-blur-lg backdrop-brightness-10 backdrop-saturate-50 flex justify-center items-center transition-all"
